...
import lisLearningImage from '@assets/lis-learning.jpg';
    ...
    <section ref={ref} className="py-20 bg-gradient-to-br from-slate-50 to-blue-50 dark:from-gray-900 dark:to-gray-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            Why Choose Learners International School Over 
          ...
          >
            While general-purpose AI tools provide broad knowledge, Learners International School is specifically engineered 
          ...
          {comparisonPoints.map((point, index) => (
            ...
            >
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                {/* Learners International School Side */}
                <motion.div 
        ...
        >
          ...
          <p className="text-lg text-gray-600 dark:text-gray-400 text-center mb-12 max-w-3xl mx-auto">
            Compare how ChatGPT and Learners International School respond to the same question. Notice how our platform 
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            {/* Learners International School Comparison */}
            <motion.div
              variants={cardVariants}
              initial="hidden"
              animate={isInView ? "visible" : "hidden"}
            ...
            >
              <div className="bg-gradient-to-r from-green-500 to-emerald-500 p-4">
                <h4 className="text-xl font-bold text-white flex items-center">
                  ...
                  Learners International School - Focused Learning
                </h4>
              </div>
              <div className="p-4">
                <img 
                  src={lisLearningImage} 
                  alt="Learners International School structured learning response" 
                  className="w-full h-auto rounded-lg shadow-md"
                />
                <p className="mt-4 text-sm text-gray-600 dark:text-gray-400">
        ...
        >
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-8 text-white">
            ...
            <p className="text-xl mb-6 opacity-90">
              Explore our detailed comparison to understand how Learners International School revolutionizes learning
            </p>
