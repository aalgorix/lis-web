        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16">
          <div>
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-secondary mb-4 sm:mb-6" data-testid="contact-title">
              Connect with <span className="text-gradient">Learners International School</span>
            </h2>
            <p className="text-base sm:text-lg text-muted mb-6 sm:mb-8" data-testid="contact-description">
              Whether you are a student, parent, teacher, or school coordinator, our team is here to support your LIS learning journey.
            </p>
            ...
            <div className="space-y-6">
              <div className="flex items-center space-x-4" data-testid="contact-email">
                ...
                <div>
                  ...
                  <p className="text-muted">support@learnersinternationalschool.com</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-4" data-testid="contact-phone">
                ...
                <div>
                  ...
                  <p className="text-muted">+91 90000 00000</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-4" data-testid="contact-chat">
                ...
                <div>
                  <h4 className="font-semibold text-secondary">Demo Desk</h4>
                  <p className="text-muted">Book school walkthroughs for parents and teachers</p>
                </div>
              </div>
            </div>
                ...
                <div>
                  ...
                  <Select onValueChange={(value) => handleInputChange('subject', value)} required>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="teacher">Teacher Assistance</SelectItem>
                      <SelectItem value="parent">Parent Community Onboarding</SelectItem>
