  ...
  <div className="relative min-h-screen flex flex-col lg:flex-row items-center justify-between gap-20 px-8 lg:px-20 py-12 sm:py-16 lg:py-20">
    ...
    <div className="max-w-xl text-left z-20 flex-1">
      ...
      <p className="text-lg sm:text-xl text-white/90 mb-8 leading-relaxed">
        Transform your educational experience with Learners International School - an intelligent learning companion that personalizes your training, and becomes your guide, mentor, and coach anytime, anywhere.
      </p>
