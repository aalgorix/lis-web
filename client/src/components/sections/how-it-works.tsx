...
const steps = [
  {
    ...
    icon: UserPlus,
    title: 'Apply & Enroll',
    description: 'Complete admission formalities, student profile setup, and onboarding with support from our school office.',
    details: ['Simple online application', 'Guided onboarding support', 'Class allocation', 'Parent orientation']
  },
  {
    step: '02',
    icon: BookOpen,
    title: 'Start Your Classes',
    description: 'Access your class timetable, learning materials, and daily academic plan in one place.',
    details: ['Structured weekly timetable', 'Curriculum-aligned lessons', 'Homework and assignments', 'Teacher guidance']
  },
  {
    step: '03',
    icon: Brain,
    title: 'Learn, Practice & Improve',
    description: 'Build strong understanding through classroom teaching, practice sessions, and regular assessments.',
    details: ['Doubt-solving support', 'Practice worksheets', 'Regular quizzes', 'Feedback from teachers']
  },
  {
    step: '04',
    icon: Trophy,
    title: 'Track Progress & Celebrate',
    description: 'Review academic growth with parents and teachers, celebrate milestones, and move confidently to the next level.',
    details: ['Progress reports', 'Parent-teacher updates', 'Achievement recognition', 'Future planning']
  }
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-6">
            Student Journey at <span className="bg-gradient-to-r from-purple-400 to-blue-400 bg-clip-text text-transparent">LIS</span>
          </h2>
          <p className="text-lg sm:text-xl text-gray-300 max-w-3xl mx-auto">
            From admission to achievement, every stage is designed to support student growth and family confidence.
          </p>
        </motion.div>
