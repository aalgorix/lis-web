...
// import Logo from "@assets/leaners-international-school-logo.png";
...
//               <img src={Logo} alt="Learners International School" className="h-auto w-52 object-contain" />
//             </a>
//           </Link>
//         </div>
      ...
      <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <Link href="/" className="font-semibold hover:opacity-80 inline-flex items-center">
            <img src={Logo} alt="Learners International School" className="h-auto w-52 object-contain lis-logo-white" />
          </Link>
        </div>
