        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg sm:text-xl text-gray-300 max-w-4xl mx-auto">
              The Learners International School AI Suite is a comprehensive platform that provides educational institutions, 
      ...
      <section className="py-12 sm:py-16 md:py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg sm:text-xl text-gray-300 max-w-3xl mx-auto mb-8">
              Get started with Learners International School Products API in four easy steps
            </p>
          ...
          <div className="mt-12 bg-gray-900/50 border border-white/10 rounded-xl p-6 backdrop-blur-sm">
            ...
            <pre className="text-sm text-gray-300 overflow-x-auto">
              <code>{`// Initialize the Learners International School SDK
import { LISClient } from '@lis/sdk';

const client = new LISClient({
  ...
  lastAccessedModule: 'module_8'
      ...
      <footer className="py-8 px-4 sm:px-6 lg:px-8 border-t border-white/10">
        <div className="max-w-6xl mx-auto text-center text-gray-400">
          <p>&copy; 2026 Learners International School. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
