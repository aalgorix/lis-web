    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100" data-testid="how-it-works-page">
        ...
        <div className="max-w-7xl mx-auto text-center">
          <div className="mb-8">
            <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6">
              How Learners International School
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              From sign-up to mastery, here's how Learners International School transforms your learning journey
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Why Choose Learners International School?
            </h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
            Join thousands of students and teachers who are already experiencing the future of education with Learners International School.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/signup">
